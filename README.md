...
[![CI/CD](https://github.com/backstage-learning-durelli/hello-python/actions/workflows/ci-cd.yaml/badge.svg)](https://github.com/backstage-learning-durelli/hello-python/actions/workflows/ci-cd.yaml)
...
```json
{
  "message": "Hello from hello-python!"
}
```
...
# Executar container
docker run -p 8000:8000 hello-python:latest
...
4. ✅ Publica no Docker Hub (`durellirsd/hello-python`)
...
```bash
# Via CLI
argocd app get hello-python
argocd app sync hello-python

# Ver logs
kubectl logs -n hello-python -l app=hello-python -f
```
...
kubectl get all -n hello-python

# Acessar a aplicação (port-forward)
kubectl port-forward -n hello-python svc/hello-python 8000:80
